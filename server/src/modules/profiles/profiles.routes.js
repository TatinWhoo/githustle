...
const { uploadImage, uploadPortfolioImage: uploadPortfolioImageMw } = require('../../middleware/upload');
...
router.post('/freelancers/me/avatar', authenticate, requireRole('freelancer'), ...uploadImage('image', 'avatars'), controller.uploadFreelancerAvatar);
...
router.post('/freelancers/me/portfolio-image', authenticate, requireRole('freelancer'), ...uploadPortfolioImageMw('image'), controller.uploadPortfolioImage);
...
router.post('/clients/me/avatar', authenticate, requireRole('client'), ...uploadImage('image', 'avatars'), controller.uploadClientAvatar);
